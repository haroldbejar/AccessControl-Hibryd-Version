...
- [x] **Fase A** — Instalación de `xlsx` y creación de `exportExcel.ts` ✅ Build: 0 errores
- [x] **Fase B** — Integrar botón "Descargar Excel" en `ReportsPage.tsx` ✅ Build: 0 errores
...
export function exportActivitySummaryToExcel(
    ...
    const rows = [
        {
            Indicador: "Período Inicio",
            Valor: fmt(data.periodStart, "dd/MM/yyyy"),
        },
